...
public class ActivityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SRMParserProvider.getParser(SRMElementTypes.Activity_2004, getParserElement(),
					SRMVisualIDRegistry.getType(SRM.diagram.edit.parts.ActivityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
