...
public class RoleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SRMParserProvider.getParser(SRMElementTypes.Role_2003, getParserElement(),
					SRMVisualIDRegistry.getType(SRM.diagram.edit.parts.RoleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
