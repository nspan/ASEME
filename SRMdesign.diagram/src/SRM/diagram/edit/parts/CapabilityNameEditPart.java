 ...
 * @generated
 */
public class CapabilityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SRMParserProvider.getParser(SRMElementTypes.Capability_2002, getParserElement(),
					SRMVisualIDRegistry.getType(SRM.diagram.edit.parts.CapabilityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
