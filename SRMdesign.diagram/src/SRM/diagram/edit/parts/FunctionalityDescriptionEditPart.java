 ...
 * @generated
 */
public class FunctionalityDescriptionEditPart extends CompartmentEditPart
		...
		if (parser == null) {
			parser = SRMParserProvider
					.getParser(
							...
							getParserElement(),
							SRMVisualIDRegistry
									.getType(SRM.diagram.edit.parts.FunctionalityDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					SRMEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
