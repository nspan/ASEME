 ...
 * @generated
 */
public class FunctionalityDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionalityDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new SRMTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SRMParserProvider.getParser(SRMElementTypes.Functionality_2001, getParserElement(),
					SRMVisualIDRegistry.getType(SRM.diagram.edit.parts.FunctionalityDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, SRMEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
