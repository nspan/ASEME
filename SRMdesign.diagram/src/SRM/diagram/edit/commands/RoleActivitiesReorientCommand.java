 ...
 * @generated
 */
public class RoleActivitiesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RoleActivitiesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return SRMBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRoleActivities_4005(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return SRMBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRoleActivities_4005(getOldSource(), getNewTarget());
	}
