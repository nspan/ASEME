 ...
 * @generated
 */
public class CapabilityCapability_activitiesReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public CapabilityCapability_activitiesReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return SRMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCapabilityCapability_activities_4002(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return SRMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCapabilityCapability_activities_4002(getOldSource(), getNewTarget());
	}
