 ...
 * @generated
 */
public class FunctionalityItemSemanticEditPolicy extends
		SRMBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public FunctionalityItemSemanticEditPolicy() {
		super(SRMElementTypes.Functionality_2003);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (SRMVisualIDRegistry.getVisualID(outgoingLink) == FunctionalityActivitiesEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (SRMElementTypes.FunctionalityActivities_4001 == req
				.getElementType()) {
			return getGEFWrapper(new FunctionalityActivitiesCreateCommand(req,
