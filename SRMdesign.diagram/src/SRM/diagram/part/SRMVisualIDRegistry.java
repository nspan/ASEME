...
public class SRMVisualIDRegistry {
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (SRMPackage.eINSTANCE.getSRMmodel().isSuperTypeOf(
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = SRM.diagram.part.SRMVisualIDRegistry
		...
		if (SRMmodelEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = SRM.diagram.part.SRMVisualIDRegistry
