...
public class SRMPaletteFactory {
	...
	private PaletteContainer createSRM1Group() {
		...
		paletteContainer
				.add(createCapabilityCapability_activities5CreationTool());
	...
	private ToolEntry createRole1CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				...
				Collections.singletonList(SRMElementTypes.Role_2002));
		entry.setId("createRole1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(SRMDiagramEditorPlugin
				.findImageDescriptor("/SRMdesign.edit/icons/full/obj16/Role.gif")); //$NON-NLS-1$
		entry.setLargeIcon(SRMDiagramEditorPlugin
				.findImageDescriptor("/SRMdesign.edit/icons/full/obj32/Role.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createRoleCapabilities2CreationTool() {
		ToolEntry entry = new ToolEntry(
				Messages.RoleCapabilities2CreationTool_title,
				Messages.RoleCapabilities2CreationTool_desc, null, null) {
		};
	...
	private ToolEntry createActivity3CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				Messages.Activity3CreationTool_title,
				Messages.Activity3CreationTool_desc,
				Collections.singletonList(SRMElementTypes.Activity_2004));
		entry.setId("createActivity3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(SRMDiagramEditorPlugin
				.findImageDescriptor("/SRMdesign.edit/icons/full/obj16/Activity.gif")); //$NON-NLS-1$
		entry.setLargeIcon(SRMDiagramEditorPlugin
				.findImageDescriptor("/SRMdesign.edit/icons/full/obj32/Activity.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createCapability4CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				...
				Messages.Capability4CreationTool_desc,
				Collections.singletonList(SRMElementTypes.Capability_2001));
		entry.setId("createCapability4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(SRMDiagramEditorPlugin
				.findImageDescriptor("/SRMdesign.edit/icons/full/obj16/Capability.gif")); //$NON-NLS-1$
		entry.setLargeIcon(SRMDiagramEditorPlugin
				.findImageDescriptor("/SRMdesign.edit/icons/full/obj32/Capability.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createCapabilityCapability_activities5CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(SRMElementTypes.FunctionalityActivities_4001));
		entry.setId("createCapabilityCapability_activities5CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(SRMElementTypes
				.getImageDescriptor(SRMElementTypes.FunctionalityActivities_4001));
	...
	private ToolEntry createFunctionality6CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				Messages.Functionality6CreationTool_title,
				Messages.Functionality6CreationTool_desc,
				Collections.singletonList(SRMElementTypes.Functionality_2003));
		entry.setId("createFunctionality6CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(SRMDiagramEditorPlugin
				.findImageDescriptor("/SRMdesign.edit/icons/full/obj16/Functionality.gif")); //$NON-NLS-1$
		entry.setLargeIcon(SRMDiagramEditorPlugin
				.findImageDescriptor("/SRMdesign.edit/icons/full/obj32/Functionality.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createFunctionalityActivities7CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				Messages.FunctionalityActivities7CreationTool_title,
				Messages.FunctionalityActivities7CreationTool_desc,
				Collections
						.singletonList(SRMElementTypes.CapabilityCapability_activities_4003));
		entry.setId("createFunctionalityActivities7CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(SRMElementTypes
				.getImageDescriptor(SRMElementTypes.CapabilityCapability_activities_4003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
