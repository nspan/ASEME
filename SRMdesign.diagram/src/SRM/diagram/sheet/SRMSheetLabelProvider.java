...
import SRM.diagram.navigator.SRMNavigatorGroup;
...
public class SRMSheetLabelProvider extends BaseLabelProvider implements ILabelProvider {
	...
	*/
	public String getText(Object element) {
		...
		if (element instanceof SRMNavigatorGroup) {
			return ((SRMNavigatorGroup) element).getGroupName();
		}
	...
	*/
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = SRMVisualIDRegistry.getVisualID(view);
			IElementType etype = SRMElementTypes.getElementType(vid);
			if (etype != null) {
				return etype;
			}
