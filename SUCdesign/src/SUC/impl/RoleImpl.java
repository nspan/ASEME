...
public class RoleImpl extends EObjectImpl implements Role {
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getParticipates_in()
	 * @generated
	 * @ordered
	 */
	protected EList<UseCase> participates_in;
	...
	protected EClass eStaticClass() {
		return SUCPackage.Literals.ROLE;
	}
	 ...
	 * @generated
	 */
	public EList<UseCase> getParticipates_in() {
		if (participates_in == null) {
			participates_in = new EObjectWithInverseResolvingEList.ManyInverse<UseCase>(UseCase.class, this, SUCPackage.ROLE__PARTICIPATES_IN, SUCPackage.USE_CASE__PARTICIPANT);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SUCPackage.ROLE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SUCPackage.ROLE__PARTICIPATES_IN:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getParticipates_in()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SUCPackage.ROLE__PARTICIPATES_IN:
				return ((InternalEList<?>)getParticipates_in()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SUCPackage.ROLE__PARTICIPATES_IN:
				getParticipates_in().clear();
				getParticipates_in().addAll((Collection<? extends UseCase>)newValue);
				return;
			case SUCPackage.ROLE__NAME:
