...
public class StateChartNavigatorContentProvider implements ICommonContentProvider {
	...
	*/
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ModelEditPart.VISUAL_ID: {
			...
			StateChartNavigatorGroup links = new StateChartNavigatorGroup(Messages.NavigatorGroupName_Model_1000_links,
			...
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(VariableEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
		...
		case NodeEditPart.VISUAL_ID: {
			...
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2001_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2001_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(NodeNodeOrCompEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					StateChartVisualIDRegistry.getType(Node10EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(NodeNodeOrCompEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					StateChartVisualIDRegistry.getType(Node11EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(NodeNodeOrCompEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					StateChartVisualIDRegistry.getType(Node12EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(NodeNodeOrCompEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					StateChartVisualIDRegistry.getType(Node13EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(NodeNodeOrCompEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
		...
		case Node2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2002_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2002_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(NodeNodeAndComp2EditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					StateChartVisualIDRegistry.getType(Node11EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
		...
		case Node3EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2004_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2004_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case Node4EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2005_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2005_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case Node5EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2006_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2006_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case Node6EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2007_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2007_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case Node7EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2008_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2008_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case Node8EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2009_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_2009_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case Node10EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_3002_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_3002_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case Node11EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_3003_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_3003_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
		...
		case Node13EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_3005_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_3005_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(NodeNodeAndCompEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					StateChartVisualIDRegistry.getType(Node11EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
		...
		case Node14EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StateChartNavigatorGroup incominglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_3006_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			StateChartNavigatorGroup outgoinglinks = new StateChartNavigatorGroup(
					Messages.NavigatorGroupName_Node_3006_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					StateChartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
	...
	*/
	 ...
	 * @generated
	 */
	private Collection<StateChartNavigatorItem> createNavigatorItems(Collection<View> views, Object parent,
			boolean isLeafs) {
