 ...
 * @generated
 */
public class StateChartNavigatorLabelProvider extends LabelProvider
	...
	*/
	static {
		StateChartDiagramEditorPlugin.getInstance().getImageRegistry().put("Navigator?UnknownElement", //$NON-NLS-1$
				ImageDescriptor.getMissingImageDescriptor());
		StateChartDiagramEditorPlugin.getInstance().getImageRegistry().put("Navigator?ImageNotFound", //$NON-NLS-1$
				ImageDescriptor.getMissingImageDescriptor());
	}
	...
	*/
	public void updateLabel(ViewerLabel label, TreePath elementPath) {
		...
		if (element instanceof StateChartNavigatorItem && !isOwnView(((StateChartNavigatorItem) element).getView())) {
			return;
		}
	...
	*/
	public Image getImage(View view) {
		...
		case ModelEditPart.VISUAL_ID:
			return getImage("Navigator?Diagram?http://statechart/1.0?Model", StateChartElementTypes.Model_1000); //$NON-NLS-1$
		case NodeEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://statechart/1.0?Node", StateChartElementTypes.Node_2001); //$NON-NLS-1$
		case Node2EditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://statechart/1.0?Node", StateChartElementTypes.Node_2002); //$NON-NLS-1$
		case VariableEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://statechart/1.0?Variable", //$NON-NLS-1$
					StateChartElementTypes.Variable_2003);
		case Node3EditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://statechart/1.0?Node", StateChartElementTypes.Node_2004); //$NON-NLS-1$
		case Node4EditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://statechart/1.0?Node", StateChartElementTypes.Node_2005); //$NON-NLS-1$
		case Node5EditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://statechart/1.0?Node", StateChartElementTypes.Node_2006); //$NON-NLS-1$
		case Node6EditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://statechart/1.0?Node", StateChartElementTypes.Node_2007); //$NON-NLS-1$
		case Node7EditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://statechart/1.0?Node", StateChartElementTypes.Node_2008); //$NON-NLS-1$
		case Node8EditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://statechart/1.0?Node", StateChartElementTypes.Node_2009); //$NON-NLS-1$
		case Node9EditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://statechart/1.0?Node", StateChartElementTypes.Node_3001); //$NON-NLS-1$
		case Node10EditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://statechart/1.0?Node", StateChartElementTypes.Node_3002); //$NON-NLS-1$
		case Node11EditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://statechart/1.0?Node", StateChartElementTypes.Node_3003); //$NON-NLS-1$
		case Node12EditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://statechart/1.0?Node", StateChartElementTypes.Node_3004); //$NON-NLS-1$
	...
	*/
	private Image getImage(String key, IElementType elementType) {
		...
		if (image == null && elementType != null && StateChartElementTypes.isKnownElementType(elementType)) {
	...
	*/
	private String getModel_1000Text(View view) {
		...
		if (domainModelElement != null) {
			...
			StateChartDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1000); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_2001Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_2001,
		...
		if (parser != null) {
			...
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5005); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_2002Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_2002,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(NodeName2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5006); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getVariable_2003Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Variable_2003,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(VariableNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5007); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_2004Text(View view) {
		...
		if (domainModelElement != null) {
			...
			StateChartDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 2004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_2005Text(View view) {
		...
		if (domainModelElement != null) {
			...
			StateChartDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 2005); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_2006Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_2006,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(NodeName3EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5009); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_2007Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_2007,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5010); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_2008Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_2008,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5011); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_2009Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_2009,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(WrappingLabel3EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5012); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_3001Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_3001,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(WrappingLabel4EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_3002Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_3002,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(NodeName4EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_3003Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_3003,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(NodeName5EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_3004Text(View view) {
		...
		if (domainModelElement != null) {
			...
			StateChartDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 3004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getNode_3005Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_3005,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(NodeName6EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5003); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getTransition_4001Text(View view) {
		IParser parser = StateChartParserProvider.getParser(StateChartElementTypes.Transition_4001,
				view.getElement() != null ? view.getElement() : view,
				StateChartVisualIDRegistry.getType(TransitionTEEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			StateChartDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private boolean isOwnView(View view) {
		return ModelEditPart.MODEL_ID.equals(StateChartVisualIDRegistry.getModelID(view));
	}
