...
public class StateChartNavigatorLinkHelper implements ILinkHelper {
	...
	*/
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = StateChartDiagramEditorPlugin.getInstance().getDocumentProvider()
	...
	*/
	public void activateEditor(IWorkbenchPage aPage, IStructuredSelection aSelection) {
		...
		if (abstractNavigatorItem instanceof StateChartNavigatorItem) {
			navigatorView = ((StateChartNavigatorItem) abstractNavigatorItem).getView();
			...
			if (navigatorGroup.getParent() instanceof StateChartNavigatorItem) {
				navigatorView = ((StateChartNavigatorItem) navigatorGroup.getParent()).getView();
			}
		}
