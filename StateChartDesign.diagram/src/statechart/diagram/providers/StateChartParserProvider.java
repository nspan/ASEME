	...
	*/
	private IParser getNodeName_5005Parser() {
		if (nodeName_5005Parser == null) {
			EAttribute[] features = new EAttribute[] { StatechartPackage.eINSTANCE.getNode_Name() };
			EAttribute[] editableFeatures = new EAttribute[] { StatechartPackage.eINSTANCE.getNode_Name() };
	...
	*/
	private IParser getVariableName_5007Parser() {
		if (variableName_5007Parser == null) {
			EAttribute[] features = new EAttribute[] { StatechartPackage.eINSTANCE.getVariable_Name() };
			EAttribute[] editableFeatures = new EAttribute[] { StatechartPackage.eINSTANCE.getVariable_Name() };
			MessageFormatParser parser = new MessageFormatParser(features, editableFeatures);
	...
	*/
	private IParser getVariableType_5008Parser() {
		if (variableType_5008Parser == null) {
			EAttribute[] features = new EAttribute[] { StatechartPackage.eINSTANCE.getVariable_Type() };
			EAttribute[] editableFeatures = new EAttribute[] { StatechartPackage.eINSTANCE.getVariable_Type() };
			MessageFormatParser parser = new MessageFormatParser(features, editableFeatures);
	...
	*/
	private IParser getTransitionTE_6001Parser() {
		if (transitionTE_6001Parser == null) {
			EAttribute[] features = new EAttribute[] { StatechartPackage.eINSTANCE.getTransition_TE() };
			EAttribute[] editableFeatures = new EAttribute[] { StatechartPackage.eINSTANCE.getTransition_TE() };
			MessageFormatParser parser = new MessageFormatParser(features, editableFeatures);
