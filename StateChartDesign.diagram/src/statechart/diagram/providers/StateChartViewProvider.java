...
public class StateChartViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return ModelEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& StateChartVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!ModelEditPart.MODEL_ID.equals(StateChartVisualIDRegistry.getModelID(op.getContainerView()))) {
		...
		return NodeEditPart.VISUAL_ID == visualID || Node2EditPart.VISUAL_ID == visualID
				|| VariableEditPart.VISUAL_ID == visualID || Node3EditPart.VISUAL_ID == visualID
				|| Node4EditPart.VISUAL_ID == visualID || Node5EditPart.VISUAL_ID == visualID
				|| Node6EditPart.VISUAL_ID == visualID || Node7EditPart.VISUAL_ID == visualID
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op.getSemanticAdapter());
		if (!StateChartElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		...
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != StateChartVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		case VariableEditPart.VISUAL_ID:
			return createVariable_2003(domainElement, containerView, index, persisted, preferencesHint);
		case Node3EditPart.VISUAL_ID:
			return createNode_2004(domainElement, containerView, index, persisted, preferencesHint);
		case Node4EditPart.VISUAL_ID:
			return createNode_2005(domainElement, containerView, index, persisted, preferencesHint);
		case Node5EditPart.VISUAL_ID:
			return createNode_2006(domainElement, containerView, index, persisted, preferencesHint);
		case Node6EditPart.VISUAL_ID:
			return createNode_2007(domainElement, containerView, index, persisted, preferencesHint);
		case Node7EditPart.VISUAL_ID:
			return createNode_2008(domainElement, containerView, index, persisted, preferencesHint);
		case Node8EditPart.VISUAL_ID:
			return createNode_2009(domainElement, containerView, index, persisted, preferencesHint);
		case Node9EditPart.VISUAL_ID:
			return createNode_3001(domainElement, containerView, index, persisted, preferencesHint);
		case Node10EditPart.VISUAL_ID:
			return createNode_3002(domainElement, containerView, index, persisted, preferencesHint);
		case Node11EditPart.VISUAL_ID:
	...
	*/
	public Node createNode_2001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setType(StateChartVisualIDRegistry.getType(NodeEditPart.VISUAL_ID));
	...
	*/
	public Node createNode_2002(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5006 = createLabel(node, StateChartVisualIDRegistry.getType(NodeName2EditPart.VISUAL_ID));
		createCompartment(node, StateChartVisualIDRegistry.getType(NodeNodeAndComp2EditPart.VISUAL_ID), false, false,
				false, false);
		return node;
	}
	...
	* @generated
	*/
	public Node createVariable_2003(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(VariableEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5007 = createLabel(node, StateChartVisualIDRegistry.getType(VariableNameEditPart.VISUAL_ID));
		Node label5008 = createLabel(node, StateChartVisualIDRegistry.getType(VariableTypeEditPart.VISUAL_ID));
		return node;
	}
	...
	* @generated
	*/
	public Node createNode_2004(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createNode_2005(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node4EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createNode_2006(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node5EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createNode_2007(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node6EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5010 = createLabel(node, StateChartVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
		return node;
	}
	...
	* @generated
	*/
	public Node createNode_2008(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node7EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5011 = createLabel(node, StateChartVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
		return node;
	}
	...
	* @generated
	*/
	public Node createNode_2009(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node8EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5012 = createLabel(node, StateChartVisualIDRegistry.getType(WrappingLabel3EditPart.VISUAL_ID));
		return node;
	}
	...
	*/
	public Node createNode_3001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node9EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		Node label5001 = createLabel(node, StateChartVisualIDRegistry.getType(WrappingLabel4EditPart.VISUAL_ID));
		return node;
	}
	...
	* @generated
	*/
	public Node createNode_3002(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node10EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	public Node createNode_3003(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node11EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	public Node createNode_3004(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node12EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createNode_3005(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node13EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		Node label5003 = createLabel(node, StateChartVisualIDRegistry.getType(NodeName6EditPart.VISUAL_ID));
		createCompartment(node, StateChartVisualIDRegistry.getType(NodeNodeAndCompEditPart.VISUAL_ID), false, false,
				false, false);
		return node;
	}
	...
	* @generated
	*/
	public Node createNode_3006(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry.getType(Node14EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	public Edge createTransition_4001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Node label6001 = createLabel(edge, StateChartVisualIDRegistry.getType(TransitionTEEditPart.VISUAL_ID));
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!ModelEditPart.MODEL_ID.equals(StateChartVisualIDRegistry.getModelID(containerView))) {
