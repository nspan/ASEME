...
public class StateChartMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {
	...
	* @generated
	*/
	public static final String MARKER_TYPE = StateChartDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			StateChartDiagramEditorUtil.selectElementsInDiagram(editor,
	...
	*/
	public static void deleteMarkers(IResource resource) {
		try {
			...
			StateChartDiagramEditorPlugin.getInstance().logError("Failed to delete validation markers", e); //$NON-NLS-1$
		}
	}
	...
	*/
	public static IMarker addMarker(IFile file, String elementId, String location, String message, int statusSeverity) {
		...
		try {
			...
			StateChartDiagramEditorPlugin.getInstance().logError("Failed to create validation marker", e); //$NON-NLS-1$
		}
		return marker;
	}
}
