...
public class StateChartOCLFactory {
	...
	*/
	private static StateChartOCLFactory getInstance() {
		StateChartOCLFactory instance = StateChartDiagramEditorPlugin.getInstance().getStateChartOCLFactory();
		if (instance == null) {
			StateChartDiagramEditorPlugin.getInstance().setStateChartOCLFactory(instance = new StateChartOCLFactory());
		}
		return instance;
	}
