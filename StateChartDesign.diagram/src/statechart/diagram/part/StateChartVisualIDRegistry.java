...
public class StateChartVisualIDRegistry {
	...
	*/
	public static int getVisualID(View view) {
		...
		return statechart.diagram.part.StateChartVisualIDRegistry.getVisualID(view.getType());
	}
	...
	*/
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (StatechartPackage.eINSTANCE.getModel().isSuperTypeOf(domainElement.eClass())
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = statechart.diagram.part.StateChartVisualIDRegistry.getModelID(containerView);
		if (!ModelEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (ModelEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = statechart.diagram.part.StateChartVisualIDRegistry.getVisualID(containerView);
		} else {
		...
		case ModelEditPart.VISUAL_ID:
			...
			if (StatechartPackage.eINSTANCE.getVariable().isSuperTypeOf(domainElement.eClass())) {
		...
		case NodeNodeOrCompEditPart.VISUAL_ID:
			...
			if (StatechartPackage.eINSTANCE.getNode().isSuperTypeOf(domainElement.eClass())
					&& isNode_3007((Node) domainElement)) {
				return Node15EditPart.VISUAL_ID;
			}
			if (StatechartPackage.eINSTANCE.getNode().isSuperTypeOf(domainElement.eClass())
					&& isNode_3008((Node) domainElement)) {
				return Node16EditPart.VISUAL_ID;
			}
			break;
	...
	*/
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case NodeEditPart.VISUAL_ID:
			...
			if (NodeActionsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case NodeNodeOrCompEditPart.VISUAL_ID:
			...
			if (Node15EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Node16EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case NodeNodeOrComp2EditPart.VISUAL_ID:
	...
	*/
	private static boolean isNode_2001(Node domainElement) {
		Object result = StateChartOCLFactory.getExpression(0, StatechartPackage.eINSTANCE.getNode(), null)
	...
	*/
	private static boolean isNode_2002(Node domainElement) {
		Object result = StateChartOCLFactory.getExpression(8, StatechartPackage.eINSTANCE.getNode(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	*/
	private static boolean isNode_2004(Node domainElement) {
		Object result = StateChartOCLFactory.getExpression(6, StatechartPackage.eINSTANCE.getNode(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	*/
	private static boolean isNode_2005(Node domainElement) {
		Object result = StateChartOCLFactory.getExpression(10, StatechartPackage.eINSTANCE.getNode(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	*/
	private static boolean isNode_2006(Node domainElement) {
		Object result = StateChartOCLFactory.getExpression(4, StatechartPackage.eINSTANCE.getNode(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	* @generated
	*/
	private static boolean isNode_3008(Node domainElement) {
		Object result = StateChartOCLFactory.getExpression(14, StatechartPackage.eINSTANCE.getNode(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getVisualID(View view) {
			return statechart.diagram.part.StateChartVisualIDRegistry.getVisualID(view);
		}
		...
		*/
		...
		public String getModelID(View view) {
			return statechart.diagram.part.StateChartVisualIDRegistry.getModelID(view);
		}
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return statechart.diagram.part.StateChartVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return statechart.diagram.part.StateChartVisualIDRegistry.checkNodeVisualID(containerView, domainElement,
					candidate);
		}
		...
		*/
		...
		public boolean isCompartmentVisualID(int visualID) {
			return statechart.diagram.part.StateChartVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		*/
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return statechart.diagram.part.StateChartVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
