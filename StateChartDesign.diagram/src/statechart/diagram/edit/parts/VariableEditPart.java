...
public class VariableEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof VariableNameEditPart) {
			((VariableNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureVariableName());
			return true;
		}
		if (childEditPart instanceof VariableTypeEditPart) {
			((VariableTypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureVariableType());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(StateChartVisualIDRegistry.getType(VariableNameEditPart.VISUAL_ID));
	}
	...
	public class VariableFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureVariableName.setBorder(new MarginBorder(getMapMode().DPtoLP(5), getMapMode().DPtoLP(10),
			...
			fFigureVartype.setCornerDimensions(new Dimension(getMapMode().DPtoLP(8), getMapMode().DPtoLP(8)));
			...
			fFigureVariableType.setBorder(new MarginBorder(getMapMode().DPtoLP(5), getMapMode().DPtoLP(10),
					getMapMode().DPtoLP(5), getMapMode().DPtoLP(10)));
	 ...
	 * @generated
	 */
	static final Font FFIGUREVARIABLENAME_FONT = new Font(Display.getCurrent(), "varName", 12, SWT.BOLD);
	 ...
	 * @generated
	 */
	static final Font FFIGUREVARIABLETYPE_FONT = new Font(Display.getCurrent(), "VarType", 12, SWT.ITALIC);
