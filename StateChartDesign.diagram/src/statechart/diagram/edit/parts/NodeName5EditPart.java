 ...
 * @generated
 */
public class NodeName5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_3003, getParserElement(),
					StateChartVisualIDRegistry.getType(statechart.diagram.edit.parts.NodeName5EditPart.VISUAL_ID));
		}
		return parser;
	}
