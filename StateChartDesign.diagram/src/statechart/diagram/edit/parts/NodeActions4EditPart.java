 ...
 * @generated
 */
public class NodeActions4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NodeActions4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_3003, getParserElement(),
					StateChartVisualIDRegistry.getType(statechart.diagram.edit.parts.NodeActions4EditPart.VISUAL_ID));
		}
		return parser;
	}
