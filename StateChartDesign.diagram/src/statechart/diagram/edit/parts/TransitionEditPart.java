...
public class TransitionEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TransitionTEEditPart) {
			((TransitionTEEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTransitionTEFigure());
			return true;
		}
		return false;
	}
	...
	*/
	 ...
	 * @generated
	 */
	static final Font FFIGURETRANSITIONTEFIGURE_FONT = new Font(Display.getCurrent(), "TransitionFont", 12, SWT.NORMAL);
