...
public class Node10EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Node10ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof NodeActions3EditPart) {
			((NodeActions3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureNodeBasicActions());
			return true;
		}
		return false;
	}
