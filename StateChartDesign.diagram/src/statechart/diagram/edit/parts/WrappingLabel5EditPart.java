...
public class WrappingLabel5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_3007, getParserElement(),
					StateChartVisualIDRegistry.getType(statechart.diagram.edit.parts.WrappingLabel5EditPart.VISUAL_ID));
		}
		return parser;
	}
