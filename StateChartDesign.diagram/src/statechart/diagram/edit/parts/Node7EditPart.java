...
import statechart.diagram.edit.policies.Node7ItemSemanticEditPolicy;
...
public class Node7EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Node7ItemSemanticEditPolicy());
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(StateChartVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
	}
