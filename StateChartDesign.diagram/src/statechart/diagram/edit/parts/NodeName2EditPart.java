...
public class NodeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = StateChartParserProvider.getParser(StateChartElementTypes.Node_2002, getParserElement(),
					StateChartVisualIDRegistry.getType(statechart.diagram.edit.parts.NodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
