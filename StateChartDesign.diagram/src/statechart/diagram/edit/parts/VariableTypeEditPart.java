 ...
 * @generated
 */
public class VariableTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new StateChartTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = StateChartParserProvider.getParser(StateChartElementTypes.Variable_2003, getParserElement(),
					StateChartVisualIDRegistry.getType(statechart.diagram.edit.parts.VariableTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
