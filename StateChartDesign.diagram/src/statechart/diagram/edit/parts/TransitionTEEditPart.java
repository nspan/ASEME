 ...
 * @generated
 */
public class TransitionTEEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				StateChartVisualIDRegistry.getType(statechart.diagram.edit.parts.TransitionTEEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = StateChartParserProvider.getParser(StateChartElementTypes.Transition_4001, getParserElement(),
					StateChartVisualIDRegistry.getType(statechart.diagram.edit.parts.TransitionTEEditPart.VISUAL_ID));
		}
		return parser;
	}
