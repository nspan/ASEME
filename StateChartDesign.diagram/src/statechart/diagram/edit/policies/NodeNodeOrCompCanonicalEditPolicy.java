 ...
 * @generated
 */
public class NodeNodeOrCompCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<StateChartNodeDescriptor> childDescriptors = StateChartDiagramUpdater
				.getNodeNodeOrComp_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<StateChartNodeDescriptor> childDescriptors = StateChartDiagramUpdater
				.getNodeNodeOrComp_7001SemanticChildren((View) getHost().getModel());
