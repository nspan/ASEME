 ...
 * @generated
 */
public class Node16CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public Node16CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_Node_3008(newElement);
