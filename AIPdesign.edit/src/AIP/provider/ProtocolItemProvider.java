...
/**
 * This is the item provider adapter for a {@link AIP.Protocol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Protocol_participants_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Protocol_participants_feature", "_UI_Protocol_type"),
				 AIPPackage.Literals.PROTOCOL__PARTICIPANTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AIPPackage.Literals.PROTOCOL__NAME,
				 true,
				 false,
				 false,
