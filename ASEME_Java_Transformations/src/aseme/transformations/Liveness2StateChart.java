...
"followBall = Stare+.[SpecialAction]");
		Liveness2StateChart tr = new Liveness2StateChart();
		Model model = tr.formula(liveness, new String("Goalie")); 
		String filename=new File("Goalie"+".stct").getAbsolutePath();
		tr.saveTransformedModel(model, filename);
