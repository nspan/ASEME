	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof SAG.diagram.navigator.SAGDomainNavigatorItem) {
					SAG.diagram.navigator.SAGDomainNavigatorItem domainNavigatorItem = (SAG.diagram.navigator.SAGDomainNavigatorItem) adaptableObject;
		...
		}, SAG.diagram.navigator.SAGDomainNavigatorItem.class);
	}
