 ...
 * @generated
 */
public class SAGDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof SAGDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((SAGDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new SAGDomainNavigatorItem((EObject) objects[i],
