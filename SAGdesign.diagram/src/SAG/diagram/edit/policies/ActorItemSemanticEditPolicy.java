 ...
 * @generated
 */
public class ActorItemSemanticEditPolicy extends SAGBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ActorItemSemanticEditPolicy() {
		super(SAGElementTypes.Actor_2001);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (SAGVisualIDRegistry.getVisualID(incomingLink) == GoalDependeeEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (SAGVisualIDRegistry.getVisualID(outgoingLink) == ActorMy_goalEditPart.VISUAL_ID) {
