...
public class GoalNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SAGParserProvider.getParser(SAGElementTypes.Goal_2002, getParserElement(),
					SAGVisualIDRegistry.getType(SAG.diagram.edit.parts.GoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}
