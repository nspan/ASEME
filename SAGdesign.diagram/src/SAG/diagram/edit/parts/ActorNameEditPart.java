...
public class ActorNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new SAGTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SAGParserProvider.getParser(SAGElementTypes.Actor_2001, getParserElement(),
					SAGVisualIDRegistry.getType(SAG.diagram.edit.parts.ActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, SAGEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
