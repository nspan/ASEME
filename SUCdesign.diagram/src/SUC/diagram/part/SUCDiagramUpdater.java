...
public class SUCDiagramUpdater {
	...
	* @generated
	*/
	public static List<SUCNodeDescriptor> getSUCmodel_1000SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getUsecases().iterator(); it.hasNext();) {
			...
			int visualID = SUCVisualIDRegistry.getNodeVisualID(view, childElement);
	...
	*/
	 ...
	 * @generated
	 */
	public static List<SUCLinkDescriptor> getSUCmodel_1000ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<SUCLinkDescriptor> getUseCase_2002ContainedLinks(View view) {
		UseCase modelElement = (UseCase) view.getElement();
		LinkedList<SUCLinkDescriptor> result = new LinkedList<SUCLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_UseCase_Include_4001(modelElement));
		return result;
	}
	...
	public static List<SUCLinkDescriptor> getRole_2001ContainedLinks(View view) {
		...
		LinkedList<SUCLinkDescriptor> result = new LinkedList<SUCLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_Role_Participates_in_4002(modelElement));
		return result;
	}
	...
	public static List<SUCLinkDescriptor> getUseCase_2002IncomingLinks(View view) {
		...
		LinkedList<SUCLinkDescriptor> result = new LinkedList<SUCLinkDescriptor>();
		result.addAll(getIncomingFeatureModelFacetLinks_UseCase_Include_4001(modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Role_Participates_in_4002(modelElement, crossReferences));
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<SUCLinkDescriptor> getIncomingFeatureModelFacetLinks_UseCase_Include_4001(UseCase target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<SUCLinkDescriptor> result = new LinkedList<SUCLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == SUCPackage.eINSTANCE.getUseCase_Include()) {
				result.add(new SUCLinkDescriptor(setting.getEObject(), target, SUCElementTypes.UseCaseInclude_4001,
	 ...
	 * @generated
	 */
	private static Collection<SUCLinkDescriptor> getIncomingFeatureModelFacetLinks_Role_Participates_in_4002(
			UseCase target, Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<SUCLinkDescriptor> result = new LinkedList<SUCLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == SUCPackage.eINSTANCE.getRole_Participates_in()) {
				result.add(new SUCLinkDescriptor(setting.getEObject(), target, SUCElementTypes.RoleParticipates_in_4002,
	...
	* @generated
	*/
	private static Collection<SUCLinkDescriptor> getOutgoingFeatureModelFacetLinks_UseCase_Include_4001(
			UseCase source) {
		LinkedList<SUCLinkDescriptor> result = new LinkedList<SUCLinkDescriptor>();
		for (Iterator<?> destinations = source.getInclude().iterator(); destinations.hasNext();) {
			UseCase destination = (UseCase) destinations.next();
			result.add(new SUCLinkDescriptor(source, destination, SUCElementTypes.UseCaseInclude_4001,
					UseCaseIncludeEditPart.VISUAL_ID));
		}
		return result;
	}
	...
	* @generated
	*/
	private static Collection<SUCLinkDescriptor> getOutgoingFeatureModelFacetLinks_Role_Participates_in_4002(
			Role source) {
		LinkedList<SUCLinkDescriptor> result = new LinkedList<SUCLinkDescriptor>();
		for (Iterator<?> destinations = source.getParticipates_in().iterator(); destinations.hasNext();) {
			UseCase destination = (UseCase) destinations.next();
			result.add(new SUCLinkDescriptor(source, destination, SUCElementTypes.RoleParticipates_in_4002,
					RoleParticipates_inEditPart.VISUAL_ID));
		}
		return result;
	}
