...
import SUC.diagram.providers.ElementInitializers;
...
public class SUCDiagramEditorPlugin extends AbstractUIPlugin {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, SUCDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, SUCDiagramEditorPlugin.ID, IStatus.OK,
						message, throwable));
