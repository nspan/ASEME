...
public class SUCVisualIDRegistry {
	...
	*/
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (SUCPackage.eINSTANCE.getSUCmodel().isSuperTypeOf(domainElement.eClass())
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return SUC.diagram.part.SUCVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return SUC.diagram.part.SUCVisualIDRegistry.checkNodeVisualID(containerView, domainElement, candidate);
		}
		...
		*/
		...
		public boolean isCompartmentVisualID(int visualID) {
			return SUC.diagram.part.SUCVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		*/
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return SUC.diagram.part.SUCVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
