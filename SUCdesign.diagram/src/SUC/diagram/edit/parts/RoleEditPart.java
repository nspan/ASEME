...
public class RoleEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RoleTypeEditPart) {
			((RoleTypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureRoleTypeFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(SUCVisualIDRegistry.getType(RoleNameEditPart.VISUAL_ID));
	}
