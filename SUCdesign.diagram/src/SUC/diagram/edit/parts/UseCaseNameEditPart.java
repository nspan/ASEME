...
public class UseCaseNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SUCParserProvider.getParser(SUCElementTypes.UseCase_2002, getParserElement(),
					SUCVisualIDRegistry.getType(SUC.diagram.edit.parts.UseCaseNameEditPart.VISUAL_ID));
		}
		return parser;
	}
