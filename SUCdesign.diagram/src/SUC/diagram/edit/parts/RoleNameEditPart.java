 ...
 * @generated
 */
public class RoleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new SUCTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SUCParserProvider.getParser(SUCElementTypes.Role_2001, getParserElement(),
					SUCVisualIDRegistry.getType(SUC.diagram.edit.parts.RoleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, SUCEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
