 ...
 * @generated
 */
public class RoleTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RoleTypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SUCParserProvider.getParser(SUCElementTypes.Role_2001, getParserElement(),
					SUCVisualIDRegistry.getType(SUC.diagram.edit.parts.RoleTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, SUCEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
