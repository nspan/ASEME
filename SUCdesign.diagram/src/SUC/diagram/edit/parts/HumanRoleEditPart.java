...
import SUC.diagram.edit.policies.HumanRoleItemSemanticEditPolicy;
 ...
 * @generated
 */
public class HumanRoleEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public HumanRoleEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new HumanRoleItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof HumanRoleNameEditPart) {
			((HumanRoleNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(SUCVisualIDRegistry
				.getType(HumanRoleNameEditPart.VISUAL_ID));
	}
