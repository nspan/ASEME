...
import SUC.diagram.edit.policies.SystemRoleItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SystemRoleEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SystemRoleEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SystemRoleItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SystemRoleNameEditPart) {
			((SystemRoleNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(SUCVisualIDRegistry
				.getType(SystemRoleNameEditPart.VISUAL_ID));
	}
