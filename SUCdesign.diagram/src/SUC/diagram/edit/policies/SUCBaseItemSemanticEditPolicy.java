...
public class SUCBaseItemSemanticEditPolicy extends SemanticEditPolicy {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						SUCVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = SUCElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = SUCDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			SUCDiagramEditorPlugin.getInstance().setLinkConstraints(
