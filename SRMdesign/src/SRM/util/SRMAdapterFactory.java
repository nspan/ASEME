...
public class SRMAdapterFactory extends AdapterFactoryImpl {
	...
	protected SRMSwitch<Adapter> modelSwitch =
		new SRMSwitch<Adapter>() {
			@Override
			public Adapter caseSRMmodel(SRMmodel object) {
				return createSRMmodelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link SRM.SRMmodel <em>SR Mmodel</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSRMmodelAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link SRM.Role <em>Role</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link SRM.Activity <em>Activity</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link SRM.Capability <em>Capability</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
