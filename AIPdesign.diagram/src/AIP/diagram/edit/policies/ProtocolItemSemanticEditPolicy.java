...
import AIP.diagram.edit.commands.ProtocolParticipantsCreateCommand;
import AIP.diagram.edit.commands.ProtocolParticipantsReorientCommand;
 ...
 * @generated
 */
public class ProtocolItemSemanticEditPolicy extends AIPBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ProtocolItemSemanticEditPolicy() {
		super(AIPElementTypes.Protocol_2004);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (AIPVisualIDRegistry.getVisualID(outgoingLink) == ProtocolParticipantsEditPart.VISUAL_ID) {
