...
public class ProtocolParticipantsCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Protocol) {
			return false;
		}
		if (target != null && false == target instanceof Participant) {
			return false;
		}
		if (getSource() == null) {
		...
		return AIPBaseItemSemanticEditPolicy.getLinkConstraints().canCreateProtocolParticipants_4002(getSource(),
				getTarget());
	}
