 ...
 * @generated
 */
public class ParticipantLivenessEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AIPParserProvider.getParser(AIPElementTypes.Participant_2003, getParserElement(),
					AIPVisualIDRegistry.getType(AIP.diagram.edit.parts.ParticipantLivenessEditPart.VISUAL_ID));
		}
		return parser;
	}
