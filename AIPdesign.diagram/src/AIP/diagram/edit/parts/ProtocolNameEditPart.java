 ...
 * @generated
 */
public class ProtocolNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AIPParserProvider.getParser(AIPElementTypes.Protocol_2001, getParserElement(),
					AIPVisualIDRegistry.getType(AIP.diagram.edit.parts.ProtocolNameEditPart.VISUAL_ID));
		}
		return parser;
	}
