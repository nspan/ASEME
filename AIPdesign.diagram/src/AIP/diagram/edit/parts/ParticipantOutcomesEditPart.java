 ...
 * @generated
 */
public class ParticipantOutcomesEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AIPParserProvider.getParser(AIPElementTypes.Participant_2002, getParserElement(),
					AIPVisualIDRegistry.getType(AIP.diagram.edit.parts.ParticipantOutcomesEditPart.VISUAL_ID));
		}
		return parser;
	}
