 ...
 * @generated
 */
public class ParticipantNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AIPParserProvider.getParser(AIPElementTypes.Participant_2002, getParserElement(),
					AIPVisualIDRegistry.getType(AIP.diagram.edit.parts.ParticipantNameEditPart.VISUAL_ID));
		}
		return parser;
	}
