 ...
 * @generated
 */
public class ParticipantEngaging_rulesEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new AIPTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AIPParserProvider.getParser(AIPElementTypes.Participant_2003, getParserElement(),
					AIPVisualIDRegistry.getType(AIP.diagram.edit.parts.ParticipantEngaging_rulesEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, AIPEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
