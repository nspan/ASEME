...
import AIP.diagram.edit.policies.ProtocolItemSemanticEditPolicy;
...
public class ProtocolEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ProtocolItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProtocolNameEditPart) {
			((ProtocolNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureProtocolNameFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AIPVisualIDRegistry.getType(ProtocolNameEditPart.VISUAL_ID));
	}
	...
	public class ProtocolFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			this.add(fFigureProtocolNameFigure);
