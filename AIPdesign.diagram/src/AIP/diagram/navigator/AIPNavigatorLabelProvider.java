...
public class AIPNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	public Image getImage(View view) {
		...
		case ProtocolParticipantsEditPart.VISUAL_ID:
			return getImage("Navigator?Link?http://www.acml.tuc.gr/aseme/metamodels/AIP?Protocol?participants", //$NON-NLS-1$
					AIPElementTypes.ProtocolParticipants_4001);
		}
	...
	*/
	public String getText(View view) {
		...
		case ProtocolEditPart.VISUAL_ID:
			return getProtocol_2001Text(view);
		case ParticipantEditPart.VISUAL_ID:
			return getParticipant_2002Text(view);
		case ProtocolParticipantsEditPart.VISUAL_ID:
			return getProtocolParticipants_4001Text(view);
		}
	...
	* @generated
	*/
	private String getProtocol_2001Text(View view) {
		IParser parser = AIPParserProvider.getParser(AIPElementTypes.Protocol_2001,
		...
		if (parser != null) {
			...
			AIPDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	* @generated
	*/
	private String getParticipant_2002Text(View view) {
		IParser parser = AIPParserProvider.getParser(AIPElementTypes.Participant_2002,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			AIPDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	* @generated
	*/
	private String getProtocolParticipants_4001Text(View view) {
		return ""; //$NON-NLS-1$
	}
