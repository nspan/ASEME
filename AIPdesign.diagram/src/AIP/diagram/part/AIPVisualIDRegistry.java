...
public class AIPVisualIDRegistry {
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (AIPPackage.eINSTANCE.getAIPmodel().isSuperTypeOf(
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = AIP.diagram.part.AIPVisualIDRegistry
		...
		if (AIPmodelEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = AIP.diagram.part.AIPVisualIDRegistry
		...
		case AIPmodelEditPart.VISUAL_ID:
			if (AIPPackage.eINSTANCE.getParticipant().isSuperTypeOf(
					domainElement.eClass())) {
				return ParticipantEditPart.VISUAL_ID;
			}
			if (AIPPackage.eINSTANCE.getProtocol().isSuperTypeOf(
					domainElement.eClass())) {
