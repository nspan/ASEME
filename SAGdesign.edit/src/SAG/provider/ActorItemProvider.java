...
/**
 * This is the item provider adapter for a {@link SAG.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMy_goalPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the My goal feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMy_goalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_my_goal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_my_goal_feature", "_UI_Actor_type"),
				 SAGPackage.Literals.ACTOR__MY_GOAL,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SAGPackage.Literals.ACTOR__NAME,
				 true,
				 false,
				 false,
