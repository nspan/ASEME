 ...
 * @generated
 */
public class StateChartViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = StateChartVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = StateChartVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				...
				if (domainElement != null
						&& visualID != StateChartVisualIDRegistry
		...
		return NodeEditPart.VISUAL_ID == visualID
				...
				|| Node9EditPart.VISUAL_ID == visualID
				|| Node10EditPart.VISUAL_ID == visualID
				|| Node11EditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case Node7EditPart.VISUAL_ID:
			return createNode_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node8EditPart.VISUAL_ID:
			return createNode_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node9EditPart.VISUAL_ID:
			return createNode_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node10EditPart.VISUAL_ID:
			return createNode_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node11EditPart.VISUAL_ID:
			return createNode_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node12EditPart.VISUAL_ID:
			return createNode_3006(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createNode_2001(EObject domainElement, View containerView,
		...
		createCompartment(node,
				StateChartVisualIDRegistry
						.getType(NodeNodeOrCompEditPart.VISUAL_ID), false,
				false, false, false);
		return node;
	}
	...
	public Node createNode_2002(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry
		...
		createCompartment(node,
				StateChartVisualIDRegistry
						.getType(NodeNodeAndComp2EditPart.VISUAL_ID), false,
				false, false, false);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createVariable_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		Node label5009 = createLabel(node,
				StateChartVisualIDRegistry
						.getType(VariableTypeEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createNode_2004(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry
				.getType(Node3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createNode_2005(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry
				.getType(Node4EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createNode_2006(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry
				.getType(Node5EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createNode_2007(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry
				.getType(Node6EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createNode_3001(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry
				.getType(Node7EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createNode_3002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry
				.getType(Node8EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createNode_3003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateChartVisualIDRegistry
				.getType(Node9EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		createCompartment(node,
				StateChartVisualIDRegistry
						.getType(NodeNodeOrComp2EditPart.VISUAL_ID), false,
				false, false, false);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createNode_3005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		createCompartment(node,
				StateChartVisualIDRegistry
						.getType(NodeNodeAndCompEditPart.VISUAL_ID), false,
				false, false, false);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createNode_3006(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	...
	public Edge createTransition_4001(EObject domainElement,
		...
		edge.setType(StateChartVisualIDRegistry
