...
public class StateChartNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	public StateChartNewDiagramFileWizard(URI domainModelURI,
		...
		myFileCreationPage = new WizardNewFileCreationPage(
				Messages.StateChartNewDiagramFileWizard_CreationPageName,
				StructuredSelection.EMPTY);
		myFileCreationPage
				.setTitle(Messages.StateChartNewDiagramFileWizard_CreationPageTitle);
		myFileCreationPage
				.setDescription(NLS
						.bind(Messages.StateChartNewDiagramFileWizard_CreationPageDescription,
		...
		myFileCreationPage.setFileName(StateChartDiagramEditorUtil
				.getUniqueFileName(filePath, fileName, "kse")); //$NON-NLS-1$
	...
	public boolean performFinish() {
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				myEditingDomain,
				Messages.StateChartNewDiagramFileWizard_InitDiagramCommand,
				affectedFiles) {
