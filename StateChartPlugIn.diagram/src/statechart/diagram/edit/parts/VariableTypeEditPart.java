...
import statechart.diagram.edit.policies.StateChartTextSelectionEditPolicy;
...
public class VariableTypeEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new StateChartTextSelectionEditPolicy());
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof StateChartTextSelectionEditPolicy) {
			((StateChartTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof StateChartTextSelectionEditPolicy) {
			((StateChartTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
			...
			parser = StateChartParserProvider
					.getParser(
							...
							StateChartVisualIDRegistry
									.getType(statechart.diagram.edit.parts.VariableTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
