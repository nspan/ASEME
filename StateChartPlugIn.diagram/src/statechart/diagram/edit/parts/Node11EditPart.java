...
import statechart.diagram.edit.policies.Node11ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Node11EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Node11EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Node11ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof statechart.diagram.edit.parts.Node11EditPart) {
			types.add(StateChartElementTypes.Transition_4001);
		}
