 ...
 * @generated
 */
public class NodeNodeAndComp2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StateChartNodeDescriptor> childDescriptors = StateChartDiagramUpdater
				.getNodeNodeAndComp_7004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Node9EditPart.VISUAL_ID == StateChartVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<StateChartNodeDescriptor> childDescriptors = StateChartDiagramUpdater
				.getNodeNodeAndComp_7004SemanticChildren((View) getHost()
						.getModel());
