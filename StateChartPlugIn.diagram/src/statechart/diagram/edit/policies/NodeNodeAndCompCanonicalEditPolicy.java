 ...
 * @generated
 */
public class NodeNodeAndCompCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StateChartNodeDescriptor> childDescriptors = StateChartDiagramUpdater
				.getNodeNodeAndComp_7003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StateChartNodeDescriptor> childDescriptors = StateChartDiagramUpdater
				.getNodeNodeAndComp_7003SemanticChildren((View) getHost()
						.getModel());
