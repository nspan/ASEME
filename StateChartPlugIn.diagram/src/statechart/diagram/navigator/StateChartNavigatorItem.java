...
public class StateChartNavigatorItem extends StateChartAbstractNavigatorItem {
	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof statechart.diagram.navigator.StateChartNavigatorItem
						&& (adapterType == View.class || adapterType == EObject.class)) {
					return ((statechart.diagram.navigator.StateChartNavigatorItem) adaptableObject)
							.getView();
				}
				return null;
			}
		...
		}, statechart.diagram.navigator.StateChartNavigatorItem.class);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof statechart.diagram.navigator.StateChartNavigatorItem) {
			return EcoreUtil
					.getURI(getView())
					.equals(EcoreUtil
							.getURI(((statechart.diagram.navigator.StateChartNavigatorItem) obj)
									.getView()));
		}
