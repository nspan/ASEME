...
/**
 * This is the item provider adapter for a {@link statechart.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatechartPackage.Literals.MODEL__NODES);
			childrenFeatures.add(StatechartPackage.Literals.MODEL__TRANSITIONS);
			childrenFeatures.add(StatechartPackage.Literals.MODEL__VARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StatechartPackage.Literals.MODEL__NODES,
				 StatechartFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(StatechartPackage.Literals.MODEL__TRANSITIONS,
				 StatechartFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(StatechartPackage.Literals.MODEL__VARIABLES,
				 StatechartFactory.eINSTANCE.createVariable()));
	}
