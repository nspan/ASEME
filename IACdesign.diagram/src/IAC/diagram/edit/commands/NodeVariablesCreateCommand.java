 ...
 * @generated
 */
public class NodeVariablesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NodeVariablesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return IACBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateNodeVariables_4006(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getVariables().add(getTarget());
		}
