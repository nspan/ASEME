 ...
 * @generated
 */
public class NodeFather_ofCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NodeFather_ofCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return IACBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateNodeFather_of_4008(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getFather_of().add(getTarget());
		}
