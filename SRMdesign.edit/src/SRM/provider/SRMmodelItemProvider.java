...
/**
 * This is the item provider adapter for a {@link SRM.SRMmodel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SRMmodelItemProvider
	 ...
	 * @generated
	 */
	public SRMmodelItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SRMmodel"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SRMmodel.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SRMPackage.Literals.SR_MMODEL__ACTIVITIES,
				 SRMFactory.eINSTANCE.createActivity()));

		newChildDescriptors.add
			(createChildParameter
				(SRMPackage.Literals.SR_MMODEL__CAPABILITIES,
